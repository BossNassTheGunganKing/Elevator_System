...
public class TaskData {
    ...
    public TaskData(int time, int floor, String button, int destinationFloor, String error) {
    ...
    public String toDataString() {
        return "Data," + Integer.toString(time) + "," + Integer.toString(initialFloor) + "," + button + "," + Integer.toString(destinationFloor) + "," +error;
    }
