...
public class CarButtonPanel extends JFrame {
        ...
        for (int i = 0; i < numCars; i++) {
            ...
            for (int floor = 1; floor <= numFloors; floor++) {
                ...
                button.addActionListener(e -> {
                    int selectedCarIndex = elevatorSelector.getSelectedIndex();
                    int floorNumber = Integer.parseInt(button.getText());
                    notifyPositionUpdateListeners(selectedCarIndex, floorNumber);
                });
    ...
    private void handleFloorButtonPress(JButton button, int elevatorIndex) {
        ...
        //ElevatorSimulationWindow.sendCar(Integer.parseInt(button.getText()));
