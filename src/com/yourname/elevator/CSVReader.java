    ...
    public ArrayList<TaskData> parser(String fileLocation) {
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                // Assuming format: Time, Floor, Floor Button, Car Button, error
                ...
                String error = row[4].trim();
                //System.out.println(error);
                taskList.add(new TaskData(time, initialFloor, button, destinationFloor, error));
            }
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
